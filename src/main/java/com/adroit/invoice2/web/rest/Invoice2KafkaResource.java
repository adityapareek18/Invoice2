...
@RestController
@RequestMapping("/api/invoice-2-kafka")
public class Invoice2KafkaResource {

    private final Logger log = LoggerFactory.getLogger(Invoice2KafkaResource.class);
    ...
    public Invoice2KafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
